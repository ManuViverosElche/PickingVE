/**
 * faena/historicoCargas.js — Submenú "Histórico de Cargas" (Dashboard y Faena).
 *
 * Alineado al lenguaje visual de "Pedidos del día" (pedidosDia.js): mismo set de
 * chips, tarjetas y modales del portal de logística. Muestra los pedidos
 * cargados/enviados de las fechas pasadas, agrupados por finca, y permite
 * consultar el Punteo, el Desglose (modal tipo "Detalle") y los datos del
 * pistoleo.
 */
let dc = null;
let fechas = [];
...
export async function renderHistoricoCargas(root, dataConnector) {
