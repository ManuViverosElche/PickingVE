...
function crearPedido() {
  ...
  try {
    ...
    const spreadsheet = SpreadsheetApp.openById(SPREADSHEET_ID_BORISA);
    ...
    for (let pedidoId in pedidosMap) {
      ...
      const enlaceHoja = `https://docs.google.com/spreadsheets/d/${SPREADSHEET_ID_BORISA}/edit#gid=${newSheet.getSheetId()}`;
