...
- APK: `apks/PickingVE-debug-1.7.5.apk` (carpeta fija `apks/` en la raíz; el build la copia automáticamente cada vez).
...
- Instalar en dispositivo/emulador: `adb install -r apks\PickingVE-debug-1.7.5.apk`
